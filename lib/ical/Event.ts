...
type Time = ical.Time
type Duration = ical.Duration

import { binsearchInsert } from './helpers'
import { Component } from './Component'
import { Property } from './Property'
import { Timezone } from './Timezone'
import { RecurExpansion } from './RecurExpansion'
import { FrequencyValues } from './Recur'
...
export class Event {
  ...
  /**
   * @param component The Component to base this event on
  ...
  /**
   * Checks if this recorsd is an exception and has the RANGE=THISANDFUTURE
   * value.
   *
  ...
  getOccurrenceDetails(occurrence: Time): OccurrenceDetails {
    ...
    let item
    const result: Partial<OccurrenceDetails> = {
      // XXX: Clone?
    ...
    return result as OccurrenceDetails
  }
   ...
   */
  getRecurrenceTypes(): { [key in FrequencyValues]: boolean } {
  ...
  toJSON() {
    return { component: this.component.toJSON() }
  }
